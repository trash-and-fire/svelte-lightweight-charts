...
<Chart width={600} height={300}>
    <CandlestickSeries data={data} markers={markers}/>
</Chart>
...
<script>
    ...
    const markers = [
        ...
        {
            time: data[data.length - 30].time,
            position: 'aboveBar',
            color: '#e91e63',
            shape: 'arrowDown',
            text: 'Sell @ ' + Math.floor(data[data.length - 30].high + 2)
        },
        {
            ...
            color: '#2196F3',
            shape: 'arrowUp',
            text: 'Buy @ ' + Math.floor(data[data.length - 20].low - 2)
        },
    ];
</script>
